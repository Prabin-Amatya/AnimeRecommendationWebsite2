...
const Favorites = ({setCurrAnime, setShowAddToFavorite}) =>{
  ...
  return (
  // <div style={{display:"flex", justifyContent:"center", width:"100%", overflowX:"auto", overflowY:"hidden"}} ref={slideRef}>
    <div style={{display:"block", marginTop:"15vh", overflowX:"auto", overflowY:"hidden"}} ref={slideRef}>
